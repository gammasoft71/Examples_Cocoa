...
int main(int argc, char* argv[]) {
  // Create Button
  Button* buttonShowMessage = [[[Button alloc] initWithFrame:NSMakeRect(10, 265, 90, 32)] autorelease];
  [buttonShowMessage setTitle:@"MessageBox"];
  [buttonShowMessage setBezelStyle:NSBezelStyleRounded];
  [buttonShowMessage setTarget:buttonShowMessage];
  [buttonShowMessage setAction:@selector(OnClick:)];
  ...
  [form1 setTitle:@"MessageBox example"];
  [[form1 contentView] addSubview:buttonShowMessage];
